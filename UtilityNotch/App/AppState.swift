...
final class AppState {
    ...
    private init() {
        ...
        // Apply module order
        let defaultOrder = ["todoList", "quickNotes", "clipboardHistory", "musicControl", "fileConverter", "timer"]
    ...
    private var _enabledModuleIDs: [String] = ["todoList", "quickNotes", "clipboardHistory", "musicControl", "fileConverter", "timer"]
